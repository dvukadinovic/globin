...
class Ion(object):
	...
	def get_partition_function(self, state, temp):
		if state==0:
			return self.get_pf0(temp)
		if state==1:
			return self.get_pf1(temp)
...
K = Ion([2.01222e+00, 2.06702e+00, 2.22592e+00, 2.61039e+00, 3.39777e+00, 4.77353e+00, 6.88524e+00, 9.82105e+00],
		[1.00000e+00, 1.00000e+00, 1.00000e+00, 1.00000e+00, 1.00000e+00, 1.00000e+00, 1.00000e+00, 1.00000e+00],
		4.3407, 5.12, 39.0983)
V = Ion([3.47920e+01, 4.07579e+01, 4.75479e+01, 5.59454e+01, 6.63701e+01, 7.90427e+01, 9.40667e+01, 1.11459e+02],
		[3.18263e+01, 3.74225e+01, 4.33174e+01, 4.97643e+01, 5.68018e+01, 6.43796e+01, 7.24289e+01, 8.08903e+01],
		6.7462, 4.0, 50.9415)
Mn = Ion([6.01140e+00, 6.10240e+00, 6.40187e+00, 7.04416e+00, 8.14747e+00, 9.82265e+00, 1.21845e+01, 1.53539e+01],
		 [7.07640e+00, 7.30191e+00, 7.73916e+00, 8.42391e+00, 9.39861e+00, 1.07144e+01, 1.24219e+01, 1.45638e+01],
		 7.434, 5.39, 54.938)
