...
from scipy.constants import m_p as PROTON_MASS
...
atmosphere_scale_ID = {"tau"    : 0,
                       "cmass"  : 1,
                       "height" : 2}

ATOMIC_MASS = [1.00797, 4.00260, 6.941, 9.01218, 10.81, 12.011, 14.0067,
...
#--- hard-coded limits for temperature interpolation/extrapolation
Tmin = 2800
Tmax = 10000